      ...
      <div className="p-3 pb-safe border-t border-border bg-background">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-secondary text-foreground rounded-xl px-4 py-3 text-sm outline-none focus:ring-1 focus:ring-accent placeholder:text-muted-foreground"
          />
          <button
            onClick={handleSend}
            className="bg-accent text-accent-foreground rounded-xl px-4 py-3 transition-all duration-200 hover:scale-105 flex items-center justify-center shrink-0"
          >
